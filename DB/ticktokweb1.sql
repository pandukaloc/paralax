...
-- Dumping data for table tictokweb1.hlptw_assets: 89 rows
...
INSERT INTO `hlptw_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
	...
	(11, 1, 63, 64, 1, 'com_languages', 'com_languages', '{"core.admin":{"7":1}}'),
	...
	(18, 1, 79, 144, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1}}'),
	...
	(56, 18, 112, 113, 2, 'com_modules.module.88', 'homepagenavigation bar', '{}'),
	(57, 18, 114, 115, 2, 'com_modules.module.89', 'homebanner', '{}'),
	(58, 8, 24, 27, 2, 'com_content.category.8', 'Home ', '{}'),
	(59, 18, 116, 117, 2, 'com_modules.module.90', 'Home Aboutus', '{}'),
	(60, 18, 118, 119, 2, 'com_modules.module.91', 'Home Features', '{}'),
	(61, 18, 120, 121, 2, 'com_modules.module.92', 'Home Features', '{}'),
	(62, 18, 122, 123, 2, 'com_modules.module.93', 'Home randomfeatures', '{}'),
	(63, 18, 124, 125, 2, 'com_modules.module.94', 'Home Downloadsection', '{}'),
	(64, 18, 126, 127, 2, 'com_modules.module.95', 'Home screenshots', '{}'),
	(65, 18, 128, 129, 2, 'com_modules.module.96', 'Home Statistics', '{}'),
	(66, 18, 130, 131, 2, 'com_modules.module.97', 'Home Testimonials', '{}'),
	(67, 18, 132, 133, 2, 'com_modules.module.98', 'Home background video', '{}'),
	(68, 18, 134, 135, 2, 'com_modules.module.99', 'Home Pricing', '{}'),
	(69, 18, 136, 137, 2, 'com_modules.module.100', 'Home ourteam', '{}'),
	(70, 18, 138, 139, 2, 'com_modules.module.101', 'Home ourstory', '{}'),
	(71, 18, 140, 141, 2, 'com_modules.module.102', 'Home FAQ', '{}'),
	(72, 18, 142, 143, 2, 'com_modules.module.103', 'Home news', '{}'),
	...
	(90, 1, 175, 176, 1, '#__ucm_content.1', '#__ucm_content.1', '{}'),
	(91, 1, 177, 178, 1, '#__ucm_content.2', '#__ucm_content.2', '{}'),
	(92, 8, 56, 57, 2, 'com_content.category.14', 'Random Features', '{}');
...
INSERT INTO `hlptw_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
	...
	(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1519643949}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
-- Dumping data for table tictokweb1.hlptw_session: 1 rows
...
INSERT INTO `hlptw_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
	('cif6pu5div4iev5qe87r7oh0k6', 0, 1, '1519652016', 'joomla|s:736:"";', 0, ''),
	('cq98p774r2b48m1j3rskg8vju5', 1, 0, '1519650853', 'joomla|s:2480:"";', 816, 'tictokweb1');
...
-- Dumping data for table tictokweb1.hlptw_ucm_history: 61 rows
...
INSERT INTO `hlptw_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
	(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1519639658, ''),
	(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1519639658, ''),
	(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1519639659, '');
...
INSERT INTO `hlptw_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
	(816, 'Super User', 'tictokweb1', 'panduka29@gmail.com', '$2y$10$vEY8N/vf8Ou4.HMdjlaJj.Ry3nA9fX7CgnpPFuOx60htTYfOqYKGm', 0, 1, '2018-02-12 17:30:52', '2018-02-26 10:07:32', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

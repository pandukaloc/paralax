...
-- Dumping data for table tictokweb1.hlptw_assets: 70 rows
...
INSERT INTO `hlptw_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
	...
	(18, 1, 43, 108, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1}}'),
	...
	(56, 18, 76, 77, 2, 'com_modules.module.88', 'homepagenavigation bar', '{}'),
	(57, 18, 78, 79, 2, 'com_modules.module.89', 'homebanner', '{}'),
	(58, 8, 20, 21, 2, 'com_content.category.8', 'Home banner', '{}'),
	(59, 18, 80, 81, 2, 'com_modules.module.90', 'Home Aboutus', '{}'),
	(60, 18, 82, 83, 2, 'com_modules.module.91', 'Home Features', '{}'),
	(61, 18, 84, 85, 2, 'com_modules.module.92', 'Home Features', '{}'),
	(62, 18, 86, 87, 2, 'com_modules.module.93', 'Home randomfeatures', '{}'),
	(63, 18, 88, 89, 2, 'com_modules.module.94', 'Home Downloadsection', '{}'),
	(64, 18, 90, 91, 2, 'com_modules.module.95', 'Home screenshots', '{}'),
	(65, 18, 92, 93, 2, 'com_modules.module.96', 'Home Statistics', '{}'),
	(66, 18, 94, 95, 2, 'com_modules.module.97', 'Home Testimonials', '{}'),
	(67, 18, 96, 97, 2, 'com_modules.module.98', 'Home background video', '{}'),
	(68, 18, 98, 99, 2, 'com_modules.module.99', 'Home Pricing', '{}'),
	(69, 18, 100, 101, 2, 'com_modules.module.100', 'Home ourteam', '{}'),
	(70, 18, 102, 103, 2, 'com_modules.module.101', 'Home ourstory', '{}'),
	(71, 18, 104, 105, 2, 'com_modules.module.102', 'Home FAQ', '{}'),
	(72, 18, 106, 107, 2, 'com_modules.module.103', 'Home news', '{}');
...
-- Dumping data for table tictokweb1.hlptw_categories: 7 rows
...
INSERT INTO `hlptw_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
	(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 816, '2018-02-12 17:30:52', 0, '0000-00-00 00:00:00', 0, '*', 1),
	...
	(8, 58, 1, 11, 12, 1, 'home-banner', 'com_content', 'Home banner', 'home-banner', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"","image_alt":""}', '', '', '{"author":"","robots":""}', 816, '2018-02-16 17:37:37', 816, '2018-02-16 17:40:31', 0, '*', 1);
...
-- Dumping data for table tictokweb1.hlptw_content: 0 rows
...
INSERT INTO `hlptw_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
	...
	(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1518948437}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
-- Dumping data for table tictokweb1.hlptw_menu: 22 rows
...
INSERT INTO `hlptw_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
	...
	(89, 57, 'homebanner', '', '', 1, 'mod_tictok_home_banner', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_tictok_home_banner', 1, 1, '{"category":"8","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
	(90, 59, 'Home Aboutus', '', '', 1, 'mod_tictok_home_aboutus', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_tictok_home_aboutus', 1, 1, '{"module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
	...
	(92, 61, 'Home Features', '', '', 1, 'mod_tictok_home_features', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_tictok_home_features', 1, 1, '{"module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
INSERT INTO `hlptw_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
	('h2g7nr0vt1q2tnti16ng72te63', 1, 0, '1518948473', 'joomla|s:1328:"";', 816, 'tictokweb1');
...
INSERT INTO `hlptw_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
	(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 816, '2018-02-12 17:30:52', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
-- Dumping data for table tictokweb1.hlptw_ucm_history: 1 rows
...
INSERT INTO `hlptw_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
	(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1518948460, ''),
...
INSERT INTO `hlptw_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
	(816, 'Super User', 'tictokweb1', 'panduka29@gmail.com', '$2y$10$vEY8N/vf8Ou4.HMdjlaJj.Ry3nA9fX7CgnpPFuOx60htTYfOqYKGm', 0, 1, '2018-02-12 17:30:52', '2018-02-18 10:07:37', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);
